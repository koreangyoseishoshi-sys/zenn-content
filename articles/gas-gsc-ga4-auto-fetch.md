...
> 公開ログ: 2026-07-01、`~/zenn-content/articles/gas-gsc-ga4-auto-fetch.md`（emoji 📊 / type tech / published:true）を commit `7c73d23` → User push で Zenn 公開。URL: https://zenn.dev/kimshoshi/articles/gas-gsc-ga4-auto-fetch

# GASでGSC・GA4を毎日自動取得してスプレッドシートに蓄積する──手動アドイン運用からの脱却
